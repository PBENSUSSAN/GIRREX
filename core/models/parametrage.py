# ==============================================================================
# Fichier : core/models/parametrage.py (Version MISE À JOUR et SÉCURISÉE)
# ==============================================================================
...
# ------------------------------------------------------------------------------
# Le modèle Parametre et ValeurParametre ne sont pas affectés par la modification.
# Ils sont conservés à l'identique.
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# DÉBUT DES MODIFICATIONS : Le modèle Role est renforcé.
# ------------------------------------------------------------------------------
class Role(models.Model):
    """
    Modèle centralisant les Rôles / Fonctions Métier de l'application.
    Le champ 'nom' utilise des choix prédéfinis pour garantir la cohérence
    et la robustesse du code qui s'appuie sur ces rôles.
    """
    class RoleName(models.TextChoices):
        """SOURCE UNIQUE DE VÉRITÉ POUR LES NOMS DE RÔLES."""
...
# ------------------------------------------------------------------------------
# FIN DES MODIFICATIONS : Les autres modèles sont conservés à l'identique.
# ------------------------------------------------------------------------------
